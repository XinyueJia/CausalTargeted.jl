...
| **0.3.26** | Tip of `main` — RxInfer unified-stack test extras + smoke (#30); `CausalDynamics` compat `0.4.6` |
| **0.3.25** | On General ([#166645](https://github.com/JuliaRegistries/General/pull/166645), merged 2026-08-31) — count LMTP, bootstrap, hurdle colmaps, ZINB, planner bridge |
